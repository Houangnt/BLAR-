...
from app.vision.detection.yolov5.utils.downloads import attempt_download
...
def attempt_load(weights, map_location=None, inplace=True, fuse=True):
    ...
    for w in weights if isinstance(weights, list) else [weights]:
        ...
        # ckpt = torch.load(attempt_download(w), map_location=map_location)['model']
        # torch.save(ckpt['model'].state_dict(), 'best_yolov5s_text_barcode_detection_448.pt')
        if fuse:
            model.append(
