...
class ApplicationConfig:
    STICKER_DETECTION_VERSION=os.environ.get('PLATE_DETECTION_VERSION')
    STICKER_DETECTION_DEVICE=os.environ.get('PLATE_DETECTION_DEVICE')
    STICKER_DETECTION_YOLOV5_MODEL_PATH=os.environ.get('PLATE_DETECTION_YOLOV5_MODEL_PATH')
    STICKER_DETECTION_YOLOV5_IMAGE_SIZE=int(os.environ.get('PLATE_DETECTION_YOLOV5_IMAGE_SIZE'))
    STICKER_DETECTION_YOLOV5_N_CLASS=int(os.environ.get('PLATE_DETECTION_YOLOV5_N_CLASS'))
    STICKER_DETECTION_YOLOV5_CONF_THRES=float(os.environ.get('PLATE_DETECTION_YOLOV5_CONF_THRES'))
    STICKER_DETECTION_YOLOV5_IOU_THRES=float(os.environ.get('PLATE_DETECTION_YOLOV5_IOU_THRES'))
    STICKER_DETECTION_YOLOV5_STRIDE=int(os.environ.get('PLATE_DETECTION_YOLOV5_STRIDE'))
